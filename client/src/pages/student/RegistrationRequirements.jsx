...
const RegistrationRequirements = () => {
    ...
    // =========================================================
    // Read-only values already saved during the existing
    ...
    const handleContinue = async () => {
        ...
        // -----------------------------------------------------
        // CORRECTION SUBMISSION VALIDATION
        // -----------------------------------------------------
        ...
        try {
            ...
            // These logs do not change the existing submission
            // payload or registration behavior. They help us
            // identify why document/selfie records may not be
            // reaching Supabase.
            console.log(
                "📤 SENDING REGISTRATION REQUIREMENTS:",
                {
                    studentId,
                    email,
                    studentIdFront: preparedStudentIdFront
                        ? `PRESENT (${preparedStudentIdFront.data?.length || 0} chars)`
                        : "MISSING",
                    studentIdBack: preparedStudentIdBack
                        ? `PRESENT (${preparedStudentIdBack.data?.length || 0} chars)`
                        : "MISSING",
                    enrollmentProof: preparedEnrollmentProof
                        ? `PRESENT (${preparedEnrollmentProof.data?.length || 0} chars)`
                        : "MISSING",
                    supportingDocument: preparedSupportingDocument
                        ? `PRESENT (${preparedSupportingDocument.data?.length || 0} chars)`
                        : "MISSING",
                    selfie: selfiePreview
                        ? `PRESENT (${selfiePreview.length} chars)`
                        : "MISSING",
                }
            );
            ...
            // DIAGNOSTIC LOGS ONLY: expose the backend response
            // without changing the existing error handling.
            console.error(
                "❌ DOCUMENT UPLOAD ERROR STATUS:",
                err.response?.status
            );
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* =================================================
                    REGISTERED STUDENT INFORMATION
                    Read-only confirmation. Existing registration,
                    document, selfie, and correction logic is untouched.
                ================================================= */}
                ...
                >
                    ...
                    >
                        ...
                        >
                            Please review the information you provided before completing your requirements.
                        </div>
                ...
                {isCorrectionMode && (
                    ...
                    >
                        ...
                        >
                            You do not need to replace valid requirements. Only upload the item(s) that need correction.
                        </div>
